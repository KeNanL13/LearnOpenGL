...
private:
    ...
    unsigned int VAO,VBO,VAOCube=0,VBOCube=0,VAOQuad,VBOQuad;
    unsigned int VAOLight;
    unsigned int depthMapFBO,depthMap;
    int shadowWidth=1024,shadowHeight=1024;
    float nearField=0.1,farField=25;
    Camera camera;
...
//    QVector3D lightPos;
    float fov=45.0f;
     float x=0;
    QOpenGLShaderProgram shaderProgramDepth;
    QOpenGLShaderProgram shaderProgramLight;
    QOpenGLShaderProgram shaderProgramPointShadow;
